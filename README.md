...
- ✊ [demodiff: berlin](https://github.com/demodiff/berlin) - Scraper and unofficial historical archive of Berlin Police announcements for demonstrations and political assemblies, preserving changes as JSON Lines and readable Git diffs.
